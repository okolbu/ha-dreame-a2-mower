...
def test_lidar_top_down_per_map(coordinator_with_two_maps, tmp_path):
    ...
    assert cam0._attr_unique_id == "G2408000TESTSN0000_map_0_lidar_top_down"
    assert cam1._attr_unique_id == "G2408000TESTSN0000_map_1_lidar_top_down"
...
def test_lidar_top_down_full_per_map(coordinator_with_two_maps, tmp_path):
    ...
    assert cam._attr_unique_id == "G2408000TESTSN0000_map_0_lidar_top_down_full"
...
def test_lidar_selected_camera_unique_id(coordinator_with_two_maps):
    ...
    assert cam._attr_unique_id == "G2408000TESTSN0000_lidar_selected"
