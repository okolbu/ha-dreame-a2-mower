...
def test_migration_rewrites_mower_level_unique_ids():
    ...
    assert rewrites.get("abc123_battery_level") == "G2408000TESTSN0000_battery_level"
    # WiFi RSSI sensor (DreameA2Sensor)
    assert rewrites.get("abc123_wifi_rssi_dbm") == "G2408000TESTSN0000_wifi_rssi_dbm"
    # Lawn mower entity
    assert rewrites.get("abc123_lawn_mower") == "G2408000TESTSN0000_lawn_mower"
    # Action button
    assert rewrites.get("abc123_start_mowing") == "G2408000TESTSN0000_start_mowing"
    # Active map select
    assert rewrites.get("abc123_active_map") == "G2408000TESTSN0000_active_map"
...
def test_migration_bumps_version_when_sn_known():
    ...
    hass = MagicMock()
    coord = MagicMock(sn="G2408000TESTSN0000")
