...
def test_zone_select_per_map(coordinator_with_two_maps):
    ...
    assert "G2408000TESTSN0000_map_0_zone_target" == e0._attr_unique_id
    assert "G2408000TESTSN0000_map_1_zone_target" == e1._attr_unique_id
...
def test_spot_select_per_map(coordinator_with_two_maps):
    ...
    assert "G2408000TESTSN0000_map_0_spot_target" == e0._attr_unique_id
    assert e0._attr_device_info["identifiers"] == {
        (DOMAIN, "G2408000TESTSN0000_map_0")
    }
...
def test_edge_select_per_map(coordinator_with_two_maps):
    ...
    assert "G2408000TESTSN0000_map_0_edge_target" == e0._attr_unique_id
    assert e0._attr_device_info["identifiers"] == {
        (DOMAIN, "G2408000TESTSN0000_map_0")
    }
