...
def test_per_map_snapshot_on_subdevice(coordinator_with_two_maps):
    ...
    assert cam0._attr_unique_id == "G2408000TESTSN0000_map_0_map"
    assert cam1._attr_unique_id == "G2408000TESTSN0000_map_1_map"
...
def test_wifi_per_map_camera_unique_id_uses_map_subdevice(coordinator_with_two_maps):
    ...
    assert cam0._attr_unique_id == "G2408000TESTSN0000_map_0_wifi_heatmap"
    assert cam1._attr_unique_id == "G2408000TESTSN0000_map_1_wifi_heatmap"
    assert cam0._attr_device_info["identifiers"] == {
        (DOMAIN, "G2408000TESTSN0000_map_0")
    }
