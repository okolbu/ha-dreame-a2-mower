...
DEAD_CLASS_UIDS = {
    ...
    "G2408000TESTSN0000_wifi_view",
    # v1.0.11a5 — parent-level read-only/phantom-write surfaces
    # superseded by the per-map equivalents:
    "G2408000TESTSN0000_edgemaster",
    "G2408000TESTSN0000_mowing_efficiency",
    # v1.0.11a5 — per-map PRE-shadow sensor superseded by
    # DreameA2MapMowingEfficiencySelect:
    "G2408000TESTSN0000_map_0_pre_mowing_efficiency",
    "G2408000TESTSN0000_map_1_pre_mowing_efficiency",
}
