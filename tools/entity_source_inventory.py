...
ENTITY_SOURCE_FILES: dict[str, tuple[str, ...]] = {
    ...
    "sensor": (
        ...
        "entities/sensor/map.py",
        "entities/sensor/session.py",
        "entities/sensor/base.py",
    ),
    "switch": (
        "switch.py",
        "entities/switch/global_.py",
        "entities/switch/map.py",
        "entities/switch/base.py",
    ),
    "select": (
        "select.py",
        "entities/select/global_.py",
        "entities/select/map_settings.py",
        "entities/select/base.py",
    ),
    "number": ("number.py",),
    "time": ("time.py",),
}
