...
class MowerStateMachine:
    ...
    def _apply_s2p1_task_state(
        ...
        """
        from .snapshot import CurrentActivity, Location, MowSession, PositioningHealth
    ...
    def _apply_s2p2_event(
        ...
        from ..mower.error_codes import is_fault
    ...
    def _apply_s2p50_task_envelope(
        ...
        """
        from .snapshot import CurrentActivity, MowSession
    ...
    def _apply_s2p56_lifecycle(
        ...
        """
        from .snapshot import CurrentActivity
        if not isinstance(envelope, dict):
            return self._snapshot
    ...
    def _reconcile_mow_activity(
        ...
        from .snapshot import CurrentActivity, MowSession, Location
        updates: dict[str, Any] = {}
    ...
    def handle_heartbeat(self, hb: Any, now_unix: int) -> StateSnapshot:
        ...
        """
        from .snapshot import Connectivity
        freshness = dict(self._snapshot.field_freshness)
    ...
    def handle_position(
        ...
        *,
        ...
        """
        from .snapshot import CurrentActivity, Location
        updates: dict[str, Any] = {}
        freshness = dict(self._snapshot.field_freshness)
        for name, value in (
            ("position_x_m", x_m),
