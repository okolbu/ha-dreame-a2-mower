...
PROPERTY_TO_NAME: Final = {
    ...
    DreameMowerProperty.CLEANING_TIME.name: ["mowing_time", "Mowing Time"],
    DreameMowerProperty.CLEANED_AREA.name: ["mowed_area", "Mowed Area"],
    DreameMowerProperty.TASK_STATUS.name: ["task_status", "Task Status"],
    DreameMowerProperty.RESUME_CLEANING.name: ["resume_mowing", "Resume Mowing"],
    DreameMowerProperty.REMOTE_CONTROL.name: ["remote_control", "Remote Control"],
    DreameMowerProperty.CLEANING_PAUSED.name: ["mowing_paused", "Mowing Paused"],
    ...
    DreameMowerProperty.CLEANING_MODE.name: ["mowing_mode", "Mowing Mode"],
    DreameMowerProperty.CUSTOMIZED_CLEANING.name: [
        "customized_cleaning",
        "Customized Mowing",
    ],
    DreameMowerProperty.CHILD_LOCK.name: ["child_lock", "Child Lock"],
    DreameMowerProperty.CLEANING_CANCEL.name: ["mowing_cancel", "Mowing Cancel"],
    ...
    DreameMowerProperty.CLEANING_COUNT.name: ["mowing_count", "Mowing Count"],
